    ...
    <div className="events-container">
      <div className="events-body">
        ...
        <section className="innovators-section">
          <h1 className="innovators-title">
            Revolutionizing Innovation and Creativity
          </h1>
          <p className="innovators-description">
            Join the revolution of innovation and creativity. Discover
            groundbreaking ideas, connect with visionaries, and be part of a
            community shaping the future. With interactive sessions,
            cutting-edge technologies, and inspiring speakers, this event
            promises to fuel your passion for innovation and empower your next
            big idea.
          </p>
